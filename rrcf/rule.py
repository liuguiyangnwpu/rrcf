...
class Rule(ABC):
    ...
    @classmethod
    def generate(cls, bounding_box: np.ndarray, mode: str = "uniform"):
        """
    ...
    @classmethod
    @abstractmethod
    def _generate_uniform(cls, bounding_box: np.ndarray):
        """
    ...
    @classmethod
    @abstractmethod
    def _generate_biased(cls, bounding_box: np.ndarray):
        """
